...
lib.ssMetadata = [
		{name:"337.334_atlas_", frames: [[340,447,158,147],[0,149,244,147],[416,149,81,147],[0,447,168,147],[246,149,168,147],[0,0,342,147],[0,596,120,147],[122,596,120,147],[340,298,168,147],[170,298,168,147],[344,0,168,147],[0,298,168,147],[170,447,168,147]]}
];
...
(lib._1987 = function() {
	this.spriteSheet = ss["337.334_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._337334 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(175.1,208.8,2422.4,191.7);
// library properties:
lib.properties = {
	width: 337,
	height: 334,
	...
	webfonts: {},
	manifest: [
		{src:"images/337.334_atlas_.png", id:"337.334_atlas_"}
	],
	preloads: []
};
