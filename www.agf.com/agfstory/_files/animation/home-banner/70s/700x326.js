...
lib.ssMetadata = [
		{name:"700x326_atlas_", frames: [[0,0,1521,326],[0,328,722,326],[724,328,183,46]]}
];
...
p.nominalBounds = new cjs.Rectangle(-92,-25,183,46);
...
(lib._700x326 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(605.7,217.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(255,255,255,0.8)").s().p("AgXAlIAAhHIASAAIAAAJQAFgGADgDQADgCAFAAQAGAAAHADIgGARQgFgDgEAAQgEAAgDACQgCADgCAFQgBAGAAASIAAAWg");
	this.shape_1.setTransform(599.5,219.1);
	...
	this.shape_2.setTransform(592,219.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("rgba(255,255,255,0.8)").s().p("AgMAzIAAg4IgMAAIAAgPIAMAAIAAgGQAAgJACgEQABgFAGgDQAEgDAHAAQAJAAAIACIgDAOIgIgBQgFAAgCACQgBABAAAGIAAAGIAOAAIAAAPIgOAAIAAA4g");
	this.shape_3.setTransform(585.6,217.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("rgba(255,255,255,0.8)").s().p("AAOAlIAAglQAAgLgCgDQgBgDgDgCQgCgCgEgBQgEAAgEADQgEADgBAFQgCAEAAALIAAAhIgTAAIAAhHIASAAIAAAKQAKgMAMAAQAHAAAFACQAGADACADQADADABAFIABANIAAAsg");
	this.shape_4.setTransform(578.8,219.1);
	...
	this.shape_5.setTransform(570.6,219.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("rgba(255,255,255,0.8)").s().p("AAeAyIAAhOIgUBOIgTAAIgUhOIAABOIgSAAIAAhjIAeAAIARBDIAShDIAeAAIAABjg");
	this.shape_6.setTransform(560.9,217.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("rgba(255,255,255,0.8)").s().p("AAOAlIAAglQAAgLgCgDQgBgDgCgCQgDgCgEgBQgEAAgEADQgEADgCAFQgBAEAAALIAAAhIgTAAIAAhHIASAAIAAAKQAJgMAOAAQAGAAAFACQAFADAEADQACADABAFIABANIAAAsg");
	this.shape_7.setTransform(547,219.1);
